// Datos para el buscador de alimentos
const productosData = {
    ...
    // Alimentos medicados
    medicados: {
        marcas: ['Monge', 'Gerolamo', 'Therapy']
    },
    
    // Alimentos para mascotas exóticas
    exoticos: {
        peces: ['Hojuelas'],
        erizos: ['Atelerix (Tenebrios y Pellet)', 'Spiker (Pellet diminuto)'],
